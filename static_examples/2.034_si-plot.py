...
# Binary section at fixed Si content (e.g., Fe-C at 1.92% Si)
binplot(db_steel, ['FE', 'C', 'SI', 'VA'], my_phases_steel,
        {v.X('C'):(0, 0.1, 0.001), v.T: (500, 1800, 10), v.X('SI'): 0.02034},
        plot_kwargs={'ax': axes, 'tielines': False})

plt.xlabel('X(C)')
plt.ylabel('Temperature (K)')
plt.title('Fe-C Phase Diagram (2.034% Si)')
plt.tight_layout()
plt.show()